...
static int count_outfilenm=0;
static char* outfilenm = NULL;
static int count_bwtfile=0;
static char* bwtfile = NULL;
...
static OPT_STRUCT opt_struct[7] = {
	{OPTTYPE_SWITCH,VARTYPE_int,NULL,NULL,NULL,"---\nmkfmi takes a BWT and calculates the FM index and the suffix array checkpoints\n\nExample cmd line\n   mkbwt sequence_filename | mkfmi outfilename\n\nwhere -L sets the minimum length of a match\n\nSee options below\n---\n"},
	{OPTTYPE_ARG,VARTYPE_charS,(void *)&outfilenm,&count_outfilenm,"|outfilenm|","      Name of file for output. Files will have different extensions. Mandatory"},
	{OPTTYPE_VALUE,VARTYPE_charS,(void *)&bwtfile,&count_bwtfile,"|bwtfile|i|","      Name of file containing BWT (output from mkbwt), stdin if not given"},
	{OPTTYPE_VALUE,VARTYPE_int,(void *)&nThreads,&count_nThreads,"|nThreads|n|","      Number of threads to use (at least 2 threads are used)"},
